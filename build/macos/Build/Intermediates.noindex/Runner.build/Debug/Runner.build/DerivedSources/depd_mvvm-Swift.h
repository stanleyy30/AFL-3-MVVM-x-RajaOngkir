...
#ifndef DEPD_MVVM_SWIFT_H
#define DEPD_MVVM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="depd_mvvm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9depd_mvvm11AppDelegate")
...
SWIFT_CLASS("_TtC9depd_mvvm17MainFlutterWindow")
